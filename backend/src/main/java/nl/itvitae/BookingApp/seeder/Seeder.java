...
public class Seeder implements CommandLineRunner {
    ...
    return hotelRepository.saveAll(
        List.of(
            ...
            new Hotel(
                ...
                getImageFromPathAsBase64String("src/main/resources/static/images/prague_inn.png")),
            new Hotel(
                "Rotterdam Stay",
                3,
                Location.ROTTERDAM,
            ...
            new Hotel(
                ...
                getImageFromPathAsBase64String("src/main/resources/static/images/berlin_base.jpg")),
            new Hotel(
  ...
  private HotelRoomType saveHotelRoomType(
      RoomType type, String name, double price, String description, Set<String> imagePaths) {
  ...
  //  saveHotelRoomTypes hotelRoomType) {
  //    hotelRoomTypeRepository.save(hotelRoomType);
    ...
    hotelRoomTypeRepository.saveAll(
        List.of(
            saveHotelRoomType(
                ...
                Set.of("src/main/resources/static/images/room_1_1.png")),
            saveHotelRoomType(
