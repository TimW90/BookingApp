...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ProblemDetail> handleUserAlreadyExistsException(ResourceAlreadyExistsException e) {
  ...
  public ResponseEntity<ProblemDetail> handleSqlException(SQLException e) {
    var problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
